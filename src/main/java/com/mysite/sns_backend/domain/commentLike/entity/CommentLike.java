package com.mysite.sns_backend.domain.commentLike.entity;
...
import com.mysite.sns_backend.domain.comment.entity.Comment;
...
public class CommentLike {
	...
	@ManyToOne
	@JoinColumn(name = "member_id", nullable = false, foreignKey = @ForeignKey(name = "fk_comment_like_member"))
